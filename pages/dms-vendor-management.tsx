...
import {preLogin} from '@app/api/log';
...
class Homepage extends React.Component<IBasicPageProps, IDashboardPageState> {
  ...
  render() {
    const {t} = this.props;
    return (
      <TotPage title={'DMS Vendors Management'}>
              ...
              {!this.state.itemEdit ?
                <>
                  <div style={{
                    ...
                    <h5 className="site-title">{'DMS Vendors Management'}</h5>
                  </div>
                  <div
                    style={{
                      display: 'flex',
                    ...
                    <div style={{display: 'flex', flexDirection: 'column', overflow: 'hidden', width: '100%'}}>
                      <table className="table">
                        ...
                        <tr>
                          ...
                          <th className="table-th" scope="col">Company Name</th>
                                ...
                                {(!!this.state.loggerInUser.authorities.filter(auth => auth.authority === "SUPER_ADMIN" || auth.authority === (getCookie('app_code') + "_SUPER_ADMIN")).length) && (
                                  <td style={{padding: '3px', paddingLeft: '30px'}}>
                                    <div style={{display: 'flex', flexDirection: 'row'}}>
                                      ...
                                      <div
                                        data-tip="Click to delete vendor"
                                        style={{margin: 'unset', marginLeft: '5px'}}
                                        className="button-icon"
                                        onClick={async () => {
                                          ...
                                          const rp = await deleteVendor({vendorId: it.id});
