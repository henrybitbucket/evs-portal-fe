...
import { editDevice, getAllDevices, getRelatedLogs, sendCommand, getMeterLogs, getCids } from '@app/api/log';
...
class Homepage extends React.Component<IBasicPageProps, IDashboardPageState> {
  ...
  render() {
    return (
            <TotPage title={'Export Active eSIM ID'}>
                        ...
                        >
                            ...
                            <>
                                <div style={{ padding: '15px', paddingTop: '20px', paddingBottom: '0px', fontWeight: 400, fontSize: '18px', color: '#000000' }}>
                                  <span>{'Device Management'} <i className="fa fa-caret-right ml-5 mr-5" /> {'Export Active eSIM ID'}</span>
                                  <h5 className="site-title">Export Active eSIM ID to CSV</h5>
                                </div>
                                <div
                                  style={{
                                    padding: '30px',
                                                            ...
                                                            <td
                                                              ...
                                                              style={{
                                                                ...
                                                                onClick={async () => {
                                                                  ...
                                                                  const tmp = this.state.selectedRows.filter(o => o.cid == it.cid)[0];
                                ...
                                <>
                                    ...
                                    >
                                        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '15px' }}>
                                          <h5 style={{ color: '#111', fontSize: '16px', minWidth: '150px', textAlign: 'right' }}>{'Profile'}</h5>
                                          <input
                                            style={{
                                              border: '1px solid',
                                              borderRadius: '5px',
                                        ...
                                        <div style={{ display: 'flex', flexDirection: 'row', marginBottom: '15px' }}>
                                          <h5 style={{ color: '#111', fontSize: '16px', minWidth: '150px', textAlign: 'right' }}>{'Activate Date'}</h5>
                                          <input
                                            style={{
                                              border: '1px solid',
                                              borderRadius: '5px',
                                          ...
                                          <div className="button-btn"
                                              onClick={async () => {
                                                ...
                                                this.state.selectedRows?.forEach(o => {
                                                  selectedCids.push(o.cid);
                                                });
                                                if (!selectedCids.length) {
                                                  this.setState({
                                                      openWarningDialog: true,
                                                      warningMessage: 'Please select data!',
                                                    });
                                                  return;
                                                }
                                                const filter = {
                                                ...
                                                if (rp) {
                                                  ...
                                                  const fileName = 'eSIM-active-request-logs-' + tag + '.csv';
