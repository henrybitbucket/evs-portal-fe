            ...
            >
              ...
              <div style={{ display: 'flex', padding: '15px', paddingTop: '0px', paddingBottom: '0px', }}>
                ...
                >
                  <span style={{
                    color: '#000000',
                    fontWeight: '500'
                  }}>Total found: {this.state.totalRecords} Buildings, {this.state.totalPages} Pages</span>
                </div>
                <div
                  className="button-btn"
                  style={{
                      ...
                      this.setState({ o: {}, clearKey: Date.now() },
                        () => {
                          this.setState({
                              ...
                              buildingIdErrorMessage: '',
                              displayNameErrorMessage: '',
                              hasTenantErrorMessage: '',
                              descriptionErrorMessage: '',
                              addressDisplayNameErrorMessage: '',
                              addressBlockErrorMessage: '',
                              addressCountryErrorMessage: '',
                              addressCityErrorMessage: '',
                              addressTownErrorMessage: '',
                              addressStreetErrorMessage: '',
                              addressPostalCodeErrorMessage: '',
                              listBlocks: [],
                              listLevels: [],
                              listUnits: [],
                              listUnitOfLevel: [],
              ...
              <Modal open={this.state.openUploadAddress}>
                ...
                >
                  ...
                  />
                  <br/>
                  <a style={{ textDecoration: 'underline' }} download
                     href={'/api/address-upload-template?importType=' + (this.state.importType === 'couple-with-msn' ? 'couple-with-msn' : 'address-only')}
          ...
          >
            ...
            <div style={{ display: 'flex' }}>
              <div style={{
                ...
                <span
                  style={{ color: '#000000', fontWeight: '500', fontSize: '20px' }}
                >Block Details</span>
              </div>
            </div>
            <div style={{ display: 'flex' }}>
              <div>
                ...
                <div
                  ...
                  onClick={async () => {
                    if (this.state.hiddenUpdate === 'flex') {
                      Swal.fire({
                        html: `<p style='text-align: center; font-size: 14px;'>Are you sure you want to delete this block: </p>
                ...
                <div
                  ...
                  onClick={() => {
                    if (this.state.selectedUnitName != null && this.state.selectedUnitName != '') {
                      if (this.state.hiddenUpdate === 'flex') {
                        Swal.fire({
                          html: `<p style='text-align: center; font-size: 14px;'>Are you sure you want to delete this unit: </p>
