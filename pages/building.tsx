...
import { getLogs, getDevices, getBuilding, saveBuilding, deleteBuilding, updateBuilding,
    getBlockOfBuilding,
    saveBlockOfBuilding,
    deleteBlockOfBuilding, getFloorLevels, saveFloorLevel, deleteFloorLevel,
    getBuildingUnits, saveBuildingUnit, deleteBuildingUnit,
} from '@app/api/log';
...
class Homepage extends React.Component<IBasicPageProps, IDashboardPageState> {
    ...
    static getInitialProps = async (args) => {
        let { query: { q, page, search, coupleState, exportCSV}, asPath, req, initialState: {} } = args;
    ...
    async componentDidMount() {
        ...
        if (this.props.exportCSVParams) {
            try {
                ...
                const url = '/api/buildings?&search=' + this.props.search;
                const method = 'POST';
                    ...
                    <PageContent>
                        ...
                        >
                            <div style={{padding: '15px', borderBottom: '1px solid #ddd', paddingTop: '20px', paddingBottom: '20px', display: "flex", flexDirection: "row", alignItems: "center",
                                backgroundColor: '#99d3ff', height: '80px'}}>
                                <h5 style={{color: '#111', fontSize: '30px', flex: "1"}}>Buildings</h5>
                                                                  {(getCookie('app_code') !== 'DMS') && (
                                                                  <>
                                                                  <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} className="box-checkbox">
                                                                    <div className="checkbox-container">
                                                                      <input
                                                                        ...
                                                                        checked={
                                                                          (this.state.checkbox?.all === 'true' || this.state.checkbox?.all === true) ? true : false
                                                                        }
                                                                        onChange={(event) => {
                                                                          if (!!event.target.checked) {
                                                                            ...
                                                                            if (!this.state.checkbox?.not_couple && !this.state.checkbox?.couple) {
                                                                              this.setState({checkbox: {
                                                                                all: true,
                                                                              }});
                                                                            } else {
                                                                  ...
                                                                  <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} className="box-checkbox">
                                                                    <div className="checkbox-container">
                                                                      <input
                                                                        ...
                                                                        id="coupled"
                                                                        name="coupled"
                                                                        value={this.state.checkbox?.coupled}
                                                                        checked={
                                                                          (this.state.checkbox?.coupled === 'true' || this.state.checkbox?.coupled === true) ? true : false
                                                                        }
                                                                        onChange={(event) => {
                                                                          if (!!event.target.checked) {
                                                                            this.setState({checkbox: {
                                                                              coupled: !!event.target.checked
                                                                            }});
                                                                          } else {
                                                                            if (!this.state.checkbox?.all && !this.state.checkbox?.not_couple) {
                                                                              this.setState({checkbox: {
                                                                                coupled: true,
                                                                              }});
                                                                            } else {
                                                                      ...
                                                                      />
                                                                      <span style={{ marginLeft: '5px' }}>{'COUPLED'}</span>
                                                                    </div>
                                                                  </div>
                                                                  ...
                                                                  <div style={{ display: 'flex', flexDirection: 'row', alignItems: 'center' }} className="box-checkbox">
                                                                    <div className="checkbox-container">
                                                                      <input
                                                                        ...
                                                                        id="not_couple"
                                                                        name="not_couple"
                                                                        value={this.state.checkbox?.not_couple}
                                                                        checked={
                                                                         (this.state.checkbox?.not_couple === 'true' || this.state.checkbox?.not_couple === true) ? true : false
                                                                        }
                                                                        onChange={(event) => {
                                                                          if (!!event.target.checked) {
                                                                            this.setState({checkbox: {
                                                                              not_couple: !!event.target.checked
                                                                            }});
                                                                          } else {
                                                                            if (!this.state.checkbox?.all && !this.state.checkbox?.couple) {
                                                                              this.setState({checkbox: {
                                                                                not_couple: true,
                                                                              }});
                                                                            } else {
                                                                      ...
                                                                      />
                                                                      <span style={{ marginLeft: '5px' }}>{'NOT COUPLE'}</span>
                                                                    </div>
                                                                  </div>
                                                                  </>
                                                                  )}
                                ...
                                <div
                                    ...
                                    onClick = {() => {
                                        ...
                                        let coupleState = 'all';
                                        if (this.state.checkbox?.coupled) {
                                            coupleState = 'coupled';
                                        }
                                        if (this.state.checkbox?.not_couple) {
                                            coupleState = 'not_couple';
                                        }
                                        url = url + '?coupleState=' + coupleState + '&search=' + search;
                                ...
                                {/*<div
                                    ...
                                    onClick = {() => {
                                        ...
                                        url = url + '?exportCSV=true&coupleState=' + coupleState + '&search=' + search;
                                        require('@app/utils/next-routes').Router.pushRoute(url);
                                    }}
                                >
                            ...
                            <div style={{display: 'flex', padding: '15px', paddingTop: '0px', paddingBottom: '0px',}}>
                                <div style={{padding: '15px', paddingTop: '20px', paddingBottom: '20px', display: "flex", flexDirection: "row", height: '40px',
                                    alignItems: "center", backgroundColor: '#a8d4f5', borderRadius: '10px', flex: 1, marginTop : '10px', marginBottom: '10px'}}
                                    className="ml-mobile"
                                >
                                    <span style={{color: '#000000', fontWeight: '500'}}>Total found: {this.state.totalRecords} Buildings, {this.state.totalPages} Pages</span>
                                </div>
                                <div
                                    className="button-btn"
                                    style = {{
                                        ...
                                        //fontSize: '20px',
                                        marginLeft: '15px', marginTop : '10px', marginBottom: '10px'
                                    }}
                                    onClick = {() => {
                                ...
                                <div
                                  ...
                                  onClick = {() => {
                                    this.setState({openUploadAddress: true, importType: 'address-only'});
                                  }}
                                >
                                  <span>{getCookie('app_code') === 'MMS' ? 'Import the Address(Address only)' : 'Import the Address'}</span>
                                </div>
                                )}
                                ...
                                <div
                                  ...
                                  onClick = {() => {
                                    this.setState({openUploadAddress: true, importType: 'couple-with-msn'});
                                  }}
                                >
                                  <span>{'Import the Address(and Coupled Meter and MCU)'}</span>
                                </div>
                                )}
                            </div>
                            <Modal open={this.state.openUploadAddress}>
                              ...
                              >
                                ...
                                />
                                <br/>
                                <a style={{textDecoration: 'underline'}} download href={'/api/address-upload-template?importType=' + (this.state.importType === 'couple-with-msn' ? 'couple-with-msn' : 'address-only')} target='_blank'>Download template</a>
                                <br/>
                                  ...
                                  <div
                                    ...
                                    onClick = {async () => {
                                      if (this.state.addressFile) {
                                        ...
                                        const url = '/api/address/upload?importType=' + (this.state.importType === 'couple-with-msn' ? 'couple-with-msn' : 'address-only');
                                        const method = 'POST';
                                        ...
                                        rp = await fetch(url,
                                          ...
                                          if (rp) {
                                            ...
                                            const tag =  moment(new Date()).format('YYYYMMDDHHmmss');
                                            const fileName = 'import-address-result-' + tag + '.csv';
                                            const url = window.URL.createObjectURL(new Blob([rp]));
                                            const link = document.createElement('a');
                                            link.href = url;
                                            link.setAttribute('download', fileName);
                            ...
                            <div style={{display: 'flex', flexDirection: 'row', background: '#fff', minHeight: '100px', padding: '15px', paddingTop: '0px',}} className='doctor-list'>
                                <div style={{display: 'flex', flexDirection: 'column', overflow: 'hidden', padding: '0', width: '100%',}}>
                                    <table className='table ml-mobile' style={{}}>
                                        <thead className="thead-dark">
                                            <tr>
                                                <th style={{backgroundColor: '#f2f3ff', color: '#111', fontWeight: '500', fontSize: '16px', width: '80px',whiteSpace: 'nowrap', textAlign: 'left',}} scope="col">Street Address</th>
                                                <th style={{backgroundColor: '#f2f3ff', color: '#111', fontWeight: '500', fontSize: '16px', width: '80px',whiteSpace: 'nowrap', textAlign: 'left',}} scope="col">Zip/Postal</th>
                                                <th style={{backgroundColor: '#f2f3ff', color: '#111', fontWeight: '500', fontSize: '16px', width: '80px', whiteSpace: 'nowrap', textAlign: 'left', }} scope="col">Building Name</th>
                    ...
                    >
                        ...
                        <div style={{display: 'flex'}}>
                            <div style={{
                                ...
                                <span
                                    style={{color: '#000000', fontWeight: '500', fontSize: '20px'}}>Block Details</span>
                            </div>
                        </div>
                        <div style={{display: 'flex'}}>
                            <div>
                        ...
                        <div style={{display: 'flex', marginTop: '10px'}}>
                            <div style={{
                                ...
                                <span
                                    style={{color: '#000000', fontWeight: '500', fontSize: '20px'}}>Level Details</span>
                            </div>
                        </div>
                        <div style={{display: 'flex'}}>
                            <div>
                        ...
                        <div style={{display: 'flex', marginTop: '10px'}}>
                            <div style={{
                                ...
                                <span
                                    style={{color: '#000000', fontWeight: '500', fontSize: '20px'}}>Unit Details</span>
                            </div>
                        </div>
                        <div style={{display: 'flex'}}>
                            <div>
