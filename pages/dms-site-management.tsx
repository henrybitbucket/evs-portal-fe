...
class Homepage extends React.Component<IBasicPageProps, IDashboardPageState> {
  ...
  static getInitialProps = async (args) => {
    ...
    let rp = await getDMSSites(params, req);
    rp = rp || {};
    ...
    return {
      ...
      searchLabel: params.options.label,
      searchDescription: params.options.description,
      params,
      buildings,
      searchBuilding,
    };
              ...
              {!this.state.itemEdit && !this.state.rowData ?
                <>
                  <div style={{
                    ...
                    <h5 className="site-title">Site Management</h5>
                  </div>
                  <div
                    style={{
                      display: 'flex',
                    ...
                    >
                      <div
                        ...
                        <input
                          ...
                          onChange={event => this.setState({ searchLabel: event.target.value })}
                        />
                      </div>
                      <div
                        style={{
                        ...
                        <input
                          ...
                          onChange={event => this.setState({ searchDescription: event.target.value })}
                        />
                      </div>
                      <div
                        style={{
                  ...
                  <div style={{
                    ...
                    <div
                      ...
                      onClick={() => {
                        const options = {
                          label: this.state.searchLabel || undefined,
                          description: this.state.searchDescription || undefined,
                        ...
                        if (Object.keys(options)?.length) {
                          ...
                          if (!!options.label) {
                            pathName = pathName.concat(`label=${options.label}&`)
                          }
                          if (!!options.description) {
                            pathName = pathName.concat(`description=${options.description}&`)
                          }
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', overflow: 'hidden', width: '100%', }}>
                      <table className='table'>
                        ...
                        <tr>
                          ...
                          <th className="table-th" scope="col">Label</th>
                          ...
                          <th className="table-th" scope="col">Radius</th>
                                ...
                                {!!this.state.loggerInUser.authorities.filter(auth => auth.authority === "SUPER_ADMIN" || auth.authority === (getCookie('app_code') + "_SUPER_ADMIN")).length && (
                                  <td style={{ padding: '3px', paddingLeft: '30px' }}>
                                    <div style={{ display: 'flex', flexDirection: 'row' }}>
                                      ...
                                      <ReactTooltip globalEventOff="click" place="bottom" type="info" effect="solid"/>
                                      <div
                                        data-tip="Click to edit site"
                                        style={{ margin: 'unset', marginLeft: '5px' }}
                                        className="button-icon"
                                        onClick={() => this.setState({ itemEdit: JSON.parse(JSON.stringify(it)) })}
                                      >
                                      ...
                                      <div
                                        ...
                                        onClick={async () => {
                                          ...
                                          if (result && result.isConfirmed) {
                                            ...
                                            let rp = await deleteDMSSite({ id: it.id });
...
class PEdit extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      checkboxOpenSite: !!this.props.data?.isOpen,
    ...
    return (
      <div style={{ paddingTop: '15px', flex: 1 }}>
        <div className="col-md-6">
          ...
          >
            <span style={{ fontSize: '20px', fontWeight: 400, color: '#000000' }}>{!!this.state.isEdit ? 'Edit site' : 'Add new site'}</span>
            <button
              type="button"
        ...
        <div className="form-group ml-10">
          ...
          >
            <Input
              ...
              name="label"
              value={this.state.displayValue.label}
              placeholder={"Label"}
              groupstyle={{ margin: "auto" }}
              onChange={value => this.handleChange('label', value)}
            />
            {this.state.validate.label === false ?
              <small
              ...
              >
                {(!this.state.displayValue.label || !this.state.displayValue.label.trim().length) ? 'Label is required!' : 'Label invalid!'}
              </small>
              : null}
          </div>
        </div>
        ...
        <div className="form-group ml-10">
          ...
          >
            <Input
              ...
              name="description"
              type="text"
              value={this.state.displayValue.description}
              placeholder={"description"}
              groupstyle={{ margin: "auto" }}
              onChange={value => this.handleChange('description', value)}
            />
            {this.state.validate.description === false ?
              <small
                className="help-block"
                style={{
                  color: '#eb0000',
              ...
              >
                {(!this.state.displayValue.description || !this.state.displayValue.description.trim().length) ? 'description is required!' : 'description invalid!'}
              </small>
              : null}
          </div>
        </div>
        ...
        <div className="form-group ml-10">
          ...
          >
            ...
            {this.state.validate.lng === false ?
              ...
              >
                {(!this.state.displayValue.lng || !this.state.displayValue.lng.trim().length) ? 'lng is required!' : 'lng invalid!'}
              </small>
              : null}
          </div>
        </div>
        ...
        <div className="form-group ml-10">
          ...
          >
            <Input
              ...
              name="lat"
              type="text"
              value={this.state.displayValue.lat}
              placeholder={"ex: 0.9992244"}
              groupstyle={{ margin: "auto" }}
              onChange={value => this.handleChange('lat', value)}
            />
            {this.state.validate.lat === false ?
              <small
                className="help-block"
                style={{
                  color: '#eb0000',
              ...
              >
                {(!this.state.displayValue.lat || !this.state.displayValue.lat.trim().length) ? 'lat is required!' : 'lat invalid!'}
              </small>
              : null}
          </div>
        </div>
        ...
        <div className="form-group ml-10">
          ...
          >
            <Input
              ...
              name="radius"
              type="text"
              value={this.state.displayValue.radius}
              placeholder={"radius"}
              groupstyle={{ margin: "auto" }}
              onChange={value => this.handleChange('radius', value)}
            />
            {this.state.validate.radius === false ?
              <small
                className="help-block"
                style={{
                  color: '#eb0000',
              ...
              >
                {(!this.state.displayValue.radius || !this.state.displayValue.radius.trim().length) ? 'radius is required!' : 'radius invalid!'}
              </small>
              : null}
          </div>
        </div>
          ...
          >
            <div className="checkbox-container">
              <input
                ...
                id="change-pwd"
                name="change-pwd"
                checked={!!this.state.checkboxOpenSite}
                value={this.state.checkboxOpenSite}
                onChange={(event) => {
                  if (!!event.target.checked) {
                    this.setState({
                      checkboxOpenSite: true,
                    });
                  } else {
                    this.setState({
                      checkboxOpenSite: false,
                    });
                  }
                }}
              />
              <span style={{ marginLeft: '5px' }}>{'Open Site'}</span>
            </div>
          </div>
        </div>
          ...
          >
            <div
              ...
              onClick={async () => {
                ...
                this.setState({loading: true});
                this.state.displayValue.isOpen = !!this.state.checkboxOpenSite;
                let rp = await saveDMSSite(this.state.displayValue);
                this.setState({loading: false});
                if (rp.success) {
                  Swal.fire({
                    html: `<p style='text-align: center; font-size: 14px;'>${'Successfully!'}</p>`,
                      ...
                      return (
                          <tr key={index}>
                            ...
                            <td style={{ textAlign: 'left', }}>
                              <span>{it.address?.locationTag}</span>
                              {false && (
                              <div style={{
                                display: "flex",
                                flexDirection: "row",
                            ...
                            <td style={{ padding: '3px', paddingLeft: '30px' }}>
                              <div style={{ display: 'flex', flexDirection: 'row' }}>
                                <div
                                  className="button-icon ml-5"
                                  data-tip="Click to remove location"
                                  onClick={async () => {
                                    let result = await Swal.fire({
                                      html: `<p style='text-align: center; font-size: 14px;'>Are you sure?</p>`,
                                      icon: 'question',
                                    ...
                                    console.info('this.state--->', this.state, it)
                                    if (result && result.isConfirmed) {
                                      let params = {
                                        siteId: this.state.displayValue?.id,
                                        linkSiteLocationId: it.locationSiteId,
                                      };
                                      let rp = await unLinkLocationSite(params);
              ...
              <div style={{
                ...
                <table className="table" style={{ width: '100%', marginTop: '10px' }}>
                  ...
                  <tr>
                    ...
                    <th className="table-th" scope="col"
                        style={{ textAlign: 'center' }}>APPLICANT
                    </th>
                  </tr>
                  </thead>
                  <tbody>
