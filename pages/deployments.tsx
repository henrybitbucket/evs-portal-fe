...
import { getLogs, getDevices, getPiUploads, getGatewayDevices, getServerStatus } from '@app/api/log';
        ...
        return (
            <TotPage title={'Provisioning Portal'}>
               ...
               <div style = {{marginBottom: '30px'}}>
                    <div style = {{ color: '#000',fontSize: '20px', padding: '20px'}}>
                        <span>Remote Server Status: {this.state.o.status}</span>
                    </div>
               </div>
            </TotPage>
        );
